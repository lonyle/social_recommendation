...
result_TS = json.load(open('data/result_exp9.3_TS.json'))
...
delta_vec = [0.08, 0.2, 0.4]#result['param_vec']
...
plt.xlabel('adoption prob. $a$', weight='bold')
...
plt.savefig('images/plot_TS_9.3_adopt_prob.eps', dpi=1200)
plt.show()