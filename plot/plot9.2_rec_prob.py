...
rec_prob_vec = [0.04, 0.1, 0.2, 0.4]#[str(x*0.2) for x in result['param_vec']]
...
ax.set_xticklabels(rec_prob_vec, fontsize=22)

plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0))
plt.ylim(0, 600)

plt.savefig('images/plot_bar9.2_rec_prob.eps', dpi=1200)
plt.show()